...
class ServicesDreamLand extends StatefulWidget {
  @override
  _ServicesDreamLandState createState() => _ServicesDreamLandState();
}

class _ServicesDreamLandState extends State<ServicesDreamLand> {

  List <ModelForCenters> centers = <ModelForCenters>[];

 Future <void> setDataForFirebase()async{
    DatabaseReference reference =
    FirebaseDatabase.instance.reference().child('DreamLand').child('servicesDream');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("طوارئ و خدمات",style: TextStyle(fontSize: 15),),
